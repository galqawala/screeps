...
function closestTask(pos, tasks) {
    ...
    tasks.forEach(task => {
        ...
        msg(pos, 'closest: ' + Object.entries(closest) + ' minRange: ' + minRange
            + ' task: ' + Object.entries(task) + ' range: ' + range);
        if (minRange > range) {
            msg(pos, Object.entries(task) + ' is closer than ' + closest + ' range: ' + range);
            minRange = range;
            closest = task;
        }
    });
